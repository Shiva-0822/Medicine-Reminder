...
export default function HomeScreen() {
  ...
  const loadMedications = useCallback(async () => {
    try {
      // Check and record missed doses first
  ...
  const setupNotifications = async () => {
    try {
      ...
      if (!token) {
        console.log("Notification permissions not granted, but app will continue to work");
        // Continue even without notifications - app functionality remains intact
      }
      ...
      // Don't throw - let the app continue to work even if notifications fail
    }
  };
  ...
  const handleClearData = async () => {
    Alert.alert(
      "Clear all data",
      "This will delete all stored medications and dose history. This action cannot be undone. Are you sure?",
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert("Deleted", "All medication data has been cleared.");
            } catch (error) {
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              await loadMedications();
              Alert.alert("Deleted", `${medicationName} has been removed.`);
            } catch (error) {
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <View style={styles.headerActions}>
              ...
              <TouchableOpacity
                style={[styles.headerDeleteButton, styles.headerDeleteButtonDanger]}
                onPress={handleClearData}
                accessibilityLabel="Delete all medication data"
              >
